            ...
            try {
                for (Resto resto : restos) {
                    if (isNetworkAccessible()) {
                        ...
                        jsonData = String.format(jsonData, resto.getName(), String.valueOf(resto.getPhone()), resto.getEmail(), resto.getLink(), resto.getPriceRange().length()>5?5:resto.getPriceRange().length(),
